#rankhospital<-function(state,cause_of_death,num){}
...
if (num>length(state_outcome$State)|num<1){stop("invalid argument")}

test<-state_outcome[state_outcome$rank_list==num,]
test<-test[2]
